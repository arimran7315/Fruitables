...
<div class="row g-4">
  <div class="col-12">
    <div class="text-center mx-auto" style="max-width: 700px;">
      ...
      <p class="mb-4">The contact form is currently inactive. Get a functional and working contact form with Ajax &amp; PHP in a few minutes. Just copy and paste the files, add a little code and you're done. <br> <a class="btn btn-primary text-decoration-none border-0" href="https://htmlcodex.com/contact-form">Download Now</a></p>
    </div>
  </div>
  <div class="col-lg-12">
  ...
  <div class="col-lg-7">
    <form action="" class="">
      ...
      <button class="btn-css w-100 btn form-control border-secondary py-3 bg-white text-primary " type="submit">Submit</button>
    </form>
  </div>
  <div class="col-lg-5">
